...
public class InitDb {
    ...
    static class InitService {
        ...
        public void dbInit1() {
            Member member = getMember("user1", "서울", "종로", "111111");
            em.persist(member);
        ...
        public void dbInit2() {
            Member member = getMember("user2", "부산", "광안리", "222222");
            em.persist(member);

            Book book1 = getBook("SPRING1 BOOK", 20000, 300);
            em.persist(book1);

            Book book2 = getBook("SPRING2 BOOK", 40000, 400);
            em.persist(book2);
